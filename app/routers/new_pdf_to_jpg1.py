...
@router.post("/convert/file", tags=["PDF to JPG"], summary="Convert PDF via File Upload")
...
@router.post("/convert/url", tags=["PDF to JPG"], summary="Convert PDF via URL")
...
@router.get("/download/{filename}", tags=["PDF to JPG"], summary="Download converted image")
